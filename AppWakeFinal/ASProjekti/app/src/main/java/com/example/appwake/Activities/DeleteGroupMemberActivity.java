...
import com.example.appwake.DeleteGroupMemberListAdapter;
...
public class DeleteGroupMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userListView = findViewById(R.id.usersListViewDeleteGroupMemberActivity);
        SearchView searchFilter = findViewById(R.id.searchViewDeleteGroupMemberActivity);

        idGrupe = getIntent().getIntExtra("idGrupe", 0);
        position = getIntent().getIntExtra("position", 0);

        finish = findViewById(R.id.btnFinishDeleteGroupMember);
        finish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeleteGroupMemberActivity.this, MainActivity.class);
            ...
            JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    try {
                        ...
                        adapter = new DeleteGroupMemberListAdapter(DeleteGroupMemberActivity.this, R.layout.user_list_view_layout, korisnici);
                        adapter.setIdGrupe(idGrupe);
                        adapter.setArrayPosition(position);
                        userListView.setAdapter(adapter);
                    }
                    catch (Exception e){
                        Toast.makeText(DeleteGroupMemberActivity.this, "An error occurred! Message:" + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(DeleteGroupMemberActivity.this, "Error reading database! Message: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });

            RequestQueue queue = Volley.newRequestQueue(DeleteGroupMemberActivity.this);
            queue.add(request);
        } catch (Exception ex) {
            Toast.makeText(DeleteGroupMemberActivity.this, "Error! Message: " + ex.getMessage(), Toast.LENGTH_LONG).show();
        }
