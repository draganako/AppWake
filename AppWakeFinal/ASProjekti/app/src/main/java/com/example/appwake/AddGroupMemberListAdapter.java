...
public class AddGroupMemberListAdapter extends ArrayAdapter<Korisnik> implements View.OnClickListener, Filterable {

    private Context context;
    private int resource;
    private AddGroupMemberListAdapter.FilterClass filter;
    ...
    public AddGroupMemberListAdapter(Context context, int resource, ArrayList<Korisnik> objects) {
    ...
    {
        if (filter == null)
            filter = new AddGroupMemberListAdapter.FilterClass();
        return filter;
    }
